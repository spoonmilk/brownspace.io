  ...
  return (
      <div className="flex flex-col items-center">
          ...
          <div className="overflow-hidden w-full">
              {[
                  { team: 'ADCS', description: 'Attitude Determination & Control Systems (ADCS) is responsible for identifying and maintaining the proper orientation of PVDX as it orbits in space, by collecting data from onboard sensors such as magnetometers and combining them with knowledge of previous states.' },
                  { team: 'Avionics', description: "Avionics is responsible for all the electronic hardware aboard the CubeSat. This involves developing all aspects of the satellite's power system, from the solar panels, and batteries, all the way to distribution and sensing." },
                  ...
                  { team: 'Structures', description: 'Designs, manufactures and tests a majority of the components of the physical satellite. There are many independent projects operating within the structures subgroup: chassis, arm mechanism, internal structures, external structures and testing.' }
              ].map((group, index) => (
                  <Subgroup key={index} subgroupName={group.team} description={group.description} />
              ))}
          </div>
