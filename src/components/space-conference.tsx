    ...
    return (
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row mt-8 w-3/4 mx-auto">
              {/* Image */}
              <img
                src="Ivy Space Coalition.png"
                className="dark:invert w-full md:w-1/2"
                alt="Ivy Space Coalition"
              />

              {/* Spacer (optional, for spacing between image and card on desktop) */}
              ...
              >
                <Card className="bg-muted/50 relative mt-8 flex flex-col items-center">
                  <CardTitle>
                    <h2 className="text-4xl mt-8 text-center isc-title">
                      Join us for the 8th annual iteration!
                    </h2>
                  </CardTitle>

                  <p className="text-2xl mt-8 text-center">
                    <span>Where: </span>
                    <span className="font-bold">Brown University</span>
                  </p>
                  <p className="text-2xl mt-8 text-center">
                    <span>Dates: </span>
                    <span className="font-bold">April 5-6, 2025</span>
                  </p>
