...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 bg-white dark:bg-gray-300 p-3",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputs({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full max-w-[500px] lg:max-w-full items-center justify-center overflow-hidden",
        className
      )}
      ref={containerRef}
    >
      ...
      {/* AnimatedBeams */}
        ...
        fromRef={div1Ref}
        toRef={div6Ref}
        duration={3} // Reduced from 12 to 3
      />
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={div1Ref}
...
const Icons = {
  openai: () => (
    <img src="https://isodrax.com/icon.png"/>
  ),
